...
*/
    ...
    public Absence(int id_user, int id_seance, int absence) {
        this.id_user = id_user;
        this.id_seance = id_seance;
        this.absence=absence;
    ...
    public Absence(int id_absence, int id_user, int id_seance, int absence) {
        this.id_absence = id_absence;
        this.id_user = id_user;
        this.id_seance = id_seance;
        this.absence=absence;
    ...
    public Absence(int id_user, int id_seance, int absence, String dateabs) {
        this.id_user = id_user;
        this.id_seance = id_seance;
        this.absence = absence;
        this.dateabs = dateabs;
    ...
    public String toString() {
        return "Absence{" + "id_absence=" + id_absence + ", id_user=" + id_user + ", id_seance=" + id_seance + ", absence=" + absence + ", dateabs=" + dateabs + ", id_mat=" + id_mat + '}';
    }
